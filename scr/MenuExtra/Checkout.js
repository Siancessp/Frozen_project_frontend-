...
const Checkout = ({route}) => {
  ...
  // console.log("lll",selectedAddress);
      ...
      <ScrollView style={{backgroundColor: 'white'}} showsVerticalScrollIndicator={false}>
        ...
        <View style={{padding: 16}}>
          ...
          <View
            ...
            <Text style={{...styles.t5, width: Dimensions.get('window').width * 0.8, }}>{selectedAddress.newname}</Text>
            <Text
              style={{
                ...styles.t3,
            ...
            <Text style={styles.t3}>
              {selectedAddress.zip_code}, {selectedAddress.state}
            </Text>
          </View>
              ...
              <View style={styles.box2}>
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      style={{...styles.t3, fontWeight: '700', fontSize: 18}}>
                      {' '}
                      {items.quantity}{' '}
                    </Text>
